...
public class TrafficStatsTest {
    ...
    public void testE2EInput1TotalCars() throws Exception {
        TrafficStatsFileRepository reader = new TrafficStatsFileRepository("src/test/java/com/example/samples/input1.txt");
    ...
    public void testE2EInput2TotalCars() throws Exception {
        TrafficStatsFileRepository reader = new TrafficStatsFileRepository("src/test/java/com/example/samples/input2.txt");
        CarCountProcessor processor = new CarCountProcessor(reader.getTrafficStats());
        processor.Process();
